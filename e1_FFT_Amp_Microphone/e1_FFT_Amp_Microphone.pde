...
final int HIGH_THLD = 100; //high threshold of band-pass frequencies
...
float energyMax = 0;
float energyThld = 10;
float[] energyHist = new float[dataNum]; //history data to show//segmentation parameters
